...
def create(account : str, wallet : str, date : datetime.datetime, name : str, description : str, value : int, verbose : bool, tags : list[str]) -> None: 
    try:
        with sqlite3.connect(u_sql.get_data("database_dir")) as conn:
            ...
            date_id : int = u_dates.get_date_id(date.date())
